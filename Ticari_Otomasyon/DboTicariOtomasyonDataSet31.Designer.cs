...
namespace Ticari_Otomasyon {
    ...
    public partial class DboTicariOtomasyonDataSet3 : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/DboTicariOtomasyonDataSet31.xsd";
        ...
        public partial class CustomersDataTable : global::System.Data.TypedTableBase<CustomersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public CustomersRow AddCustomersRow(string FirstName, string LastName, string Phone, string Phone2, string IdentityNumber, string Mail, string City, string County, string Address, string TaxAuthority) {
        ...
        public partial class CustomersRow : global::System.Data.DataRow {
            ...
            public string TaxAuthority {
                get {
                    return ((string)(this[this.tableCustomers.TaxAuthorityColumn]));
                }
                set {
                    this[this.tableCustomers.TaxAuthorityColumn] = value;
                }
            }
...
namespace Ticari_Otomasyon.DboTicariOtomasyonDataSet3TableAdapters {
    ...
    public partial class CustomersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Customers] WHERE (([Id] = @Original_Id) AND ([FirstName] = @Original_FirstName) AND ([LastName] = @Original_LastName) AND ([Phone] = @Original_Phone) AND ((@IsNull_Phone2 = 1 AND [Phone2] IS NULL) OR ([Phone2] = @Original_Phone2)) AND ([IdentityNumber] = @Original_IdentityNumber) AND ([Mail] = @Original_Mail) AND ([City] = @Original_City) AND ([County] = @Original_County) AND ([Address] = @Original_Address) AND ([TaxAuthority] = @Original_TaxAuthority))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Customers] ([FirstName], [LastName], [Phone], [Phone2], [IdentityNumber], [Mail], [City], [County], [Address], [TaxAuthority]) VALUES (@FirstName, @LastName, @Phone, @Phone2, @IdentityNumber, @Mail, @City, @County, @Address, @TaxAuthority);
SELECT Id, FirstName, LastName, Phone, Phone2, IdentityNumber, Mail, City, County, Address, TaxAuthority FROM Customers WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Customers] SET [FirstName] = @FirstName, [LastName] = @LastName, [Phone] = @Phone, [Phone2] = @Phone2, [IdentityNumber] = @IdentityNumber, [Mail] = @Mail, [City] = @City, [County] = @County, [Address] = @Address, [TaxAuthority] = @TaxAuthority WHERE (([Id] = @Original_Id) AND ([FirstName] = @Original_FirstName) AND ([LastName] = @Original_LastName) AND ([Phone] = @Original_Phone) AND ((@IsNull_Phone2 = 1 AND [Phone2] IS NULL) OR ([Phone2] = @Original_Phone2)) AND ([IdentityNumber] = @Original_IdentityNumber) AND ([Mail] = @Original_Mail) AND ([City] = @Original_City) AND ([County] = @Original_County) AND ([Address] = @Original_Address) AND ([TaxAuthority] = @Original_TaxAuthority));
SELECT Id, FirstName, LastName, Phone, Phone2, IdentityNumber, Mail, City, County, Address, TaxAuthority FROM Customers WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, FirstName, LastName, Phone, Phone2, IdentityNumber, Mail, City, County" +
                ", Address, TaxAuthority FROM dbo.Customers";
        ...
        public virtual int Fill(DboTicariOtomasyonDataSet3.CustomersDataTable dataTable) {
        ...
        public virtual DboTicariOtomasyonDataSet3.CustomersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DboTicariOtomasyonDataSet3.CustomersDataTable dataTable = new DboTicariOtomasyonDataSet3.CustomersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DboTicariOtomasyonDataSet3.CustomersDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_FirstName, string Original_LastName, string Original_Phone, string Original_Phone2, string Original_IdentityNumber, string Original_Mail, string Original_City, string Original_County, string Original_Address, string Original_TaxAuthority) {
            ...
            if ((Original_IdentityNumber == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[6].Value = ((string)(Original_IdentityNumber));
            }
            ...
            if ((Original_TaxAuthority == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[11].Value = ((string)(Original_TaxAuthority));
            }
        ...
        public virtual int Insert(string FirstName, string LastName, string Phone, string Phone2, string IdentityNumber, string Mail, string City, string County, string Address, string TaxAuthority) {
            if ((FirstName == null)) {
            ...
            if ((TaxAuthority == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[9].Value = ((string)(TaxAuthority));
            }
        ...
        public virtual int Update(
            ...
            if ((TaxAuthority == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[9].Value = ((string)(TaxAuthority));
            }
            ...
            if ((Original_IdentityNumber == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[16].Value = ((string)(Original_IdentityNumber));
            }
            if ((Original_Mail == null)) {
                throw new global::System.ArgumentNullException("Original_Mail");
            }
            ...
            if ((Original_TaxAuthority == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[21].Value = ((string)(Original_TaxAuthority));
            }
        ...
        public virtual int Update(
                    ...
                    string Original_Address, 
                    string Original_TaxAuthority) {
            return this.Update(FirstName, LastName, Phone, Phone2, IdentityNumber, Mail, City, County, Address, TaxAuthority, Original_Id, Original_FirstName, Original_LastName, Original_Phone, Original_Phone2, Original_IdentityNumber, Original_Mail, Original_City, Original_County, Original_Address, Original_TaxAuthority, Original_Id);
        }
    }
